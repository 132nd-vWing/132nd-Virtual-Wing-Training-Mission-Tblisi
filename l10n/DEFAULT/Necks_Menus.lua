...
NecksPlane = GROUP:FindByName( "617th Neck AC" )
      if NecksPlane and NecksPlane:IsAlive() then
       NecksAdvancedMenus =  MENU_GROUP:New( NecksPlane, "Neck's Advanced Menus" )
        MENU_GROUP_COMMAND:New( NecksPlane, "Activate Advanced scenario", NecksAdvancedMenus, FLAG80, NecksPlane)
        MENU_GROUP_COMMAND:New( NecksPlane, "Deactivate advanced scenario", NecksAdvancedMenus, FLAG81, NecksPlane)
        MENU_GROUP_COMMAND:New( NecksPlane, "Sa-6 ON", NecksAdvancedMenus, FLAG60, NecksPlane)
        MENU_GROUP_COMMAND:New( NecksPlane, "Sa-6 OFF", NecksAdvancedMenus, FLAG61, NecksPlane)
      end
end, {}, 10, 30 )
